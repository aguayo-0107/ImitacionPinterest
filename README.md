...
El backend en Python maneja la lógica de negocio y los endpoints. Por cuestiones de seguridad, usamos un entorno virtual:
...
3.  **Levanta el servidor web:**
    Finalmente, para exponer los endpoints y conectar la lógica alojada en `main.py`, debes ejecutar el servidor. El comando estándar para inicializar el servidor con recarga automática es:
```bash
    fastapi dev main.py 
```
---
